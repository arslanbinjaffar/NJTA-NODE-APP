...
// Create clipboardButton validator
export const onCreateClipboardButtonValidator = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
// Update clipboardButton validator
export const onEditClipboardButtonValidator = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
// Delete clipboardButton validator
export const onDeleteClipboardButtonValidator = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
