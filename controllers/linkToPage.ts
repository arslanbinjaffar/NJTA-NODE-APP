...
/*
  @desc POST create linkToPage in page
  @route POST api/v1/create/link-to-page/:userId/:pageId
  @access Public
 */
const createLinkToPage = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  try {
    ...
    return res.json({
      ...
      success: true,
      data: blockData,
      message: "LinkToPage created successfully",
    });
  } catch (error) {
    next(error);
  }
...
/*
  @desc PATCH update single linkToPage
  @route PATCH api/v1/link-to-page/:userId/:pageId/:blockId
  @access Public
 */
const updateLinkToPage = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  try {
    ...
    res.json({
      ...
      success: true,
      data: data,
      message: "LinkToPage updated successfully",
    });
  } catch (error) {
    next(error);
  }
...
/*
  @desc DELETE delete single linkToPage
  @route DELETE api/v1/link-to-page/:userId/:pageId/:blockId
  @access Public
 */
const deleteLinkToPage = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  try {
    ...
    res.json({
      ...
      success: true,
      data: {},
      message: "LinkToPage deleted successfully",
    });
  } catch (error) {
    next(error);
  }
...
export { createLinkToPage, deleteLinkToPage, updateLinkToPage };
