...
/*
  @desc POST create video in page
  @route POST api/v1/create/video/:userId/:pageId
  @access Public
 */
const createVideo = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (blockType !== "video") throw new Error("Block type not recognized");
...
/*
  @desc PATCH update single video
  @route PATCH api/v1/video/:userId/:pageId/:blockId
  @access Public
 */
...
/*
  @desc DELETE delete single video
  @route DELETE api/v1/video/:userId/:pageId/:blockId
  @access Public
 */
