...
/*
  @desc POST create audio in page
  @route POST api/v1/create/audio/:userId/:pageId
  @access Public
 */
const createAudio = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (blockType !== "audio") throw new Error("Block type not recognized");
...
/*
  @desc PATCH update single audio
  @route PATCH api/v1/audio/:userId/:pageId/:blockId
  @access Public
 */
const updateAudio = async (req: Request, res: Response, next: NextFunction) => {
...
/*
  @desc DELETE delete single audio
  @route DELETE api/v1/audio/:userId/:pageId/:blockId
  @access Public
 */
const deleteAudio = async (req: Request, res: Response, next: NextFunction) => {
  const { userId, pageId, blockId } = req.params;
...
export { createAudio, updateAudio, deleteAudio };
