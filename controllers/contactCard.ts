...
/*
  @desc POST create contact card in page
  @route POST api/v1/create/contact-card/:userId/:pageId
  @access Public
 */
const createContactCard = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
/*
  @desc PATCH update single contact card
  @route PATCH api/v1/contact-card/:userId/:pageId/:blockId
  @access Public
 */
...
/*
  @desc DELETE delete single contact card
  @route DELETE api/v1/contact-card/:userId/:pageId/:blockId
  @access Public
 */
...
export { createContactCard, updateContactCard, deleteContactCard };
