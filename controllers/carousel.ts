...
/*
  @desc Create new carousel block
  @route Post /api/v1/carousel/create/:userId/:pageId
  @access Public
 */
const createCarousel = async (
  ...
  try {
    ...
    if (blockType !== "carousel") throw new Error("Block type not recognized");
...
/*
  @desc Update carousel block
  @route PATCH /api/v1/carousel/edit/:userId/:pageId/:blockId
  @access Public
 */
...
/*
  ...
  @route del /api/v1/heading/:pageId
  @access Public
 */
...
export { createCarousel, deleteCarousel, updateCarousel };
